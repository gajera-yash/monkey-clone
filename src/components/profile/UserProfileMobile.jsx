...
const UserProfileMobile = ({ onClose }) => {
    const { currentUser, userLocation, logout } = useAuth();
                    ...
                    <div className="flex items-center gap-4">
                        ...
                        <div className="flex-1 min-w-0">
                            <div className="flex items-center gap-2">
                                ...
                                <button className="text-xs bg-yellow-400/20 text-yellow-400 px-2.5 py-0.5 rounded-full flex items-center gap-1">
                                    <span>✏️</span> Edit
                                </button>
                            </div>
                ...
                {!isPremium && (
                    <div className="bg-gradient-to-r from-yellow-500/30 via-yellow-400/20 to-yellow-500/30 border border-yellow-400/30 rounded-2xl p-4 flex items-center gap-3">
                        ...
                        <div className="flex-1">
                            <h4 className="font-bold text-yellow-400">Monkey Plus</h4>
