...
const SafetyGuidelines = React.lazy(() => import('./components/safety/SafetyGuidelines'));

// Lazy Loaded Creator Components
const CreatorOnboarding = React.lazy(() => import('./components/creator/CreatorOnboarding'));
const FaceVerification = React.lazy(() => import('./components/creator/FaceVerification'));
const VoiceVerification = React.lazy(() => import('./components/creator/VoiceVerification'));
const CreatorDashboard = React.lazy(() => import('./components/creator/CreatorDashboard'));
const CreatorWithdraw = React.lazy(() => import('./components/creator/CreatorWithdraw'));
const CreatorSettings = React.lazy(() => import('./components/creator/CreatorSettings'));
